...
import com.evistek.gallery.activity.adapter.StereoVideoAdapter;
...
public class StereoVideoFragment extends Fragment {
    ...
    @BindView(R.id.stereo_video_recyclerview)
    RecyclerView mRecyclerView;
    @BindView(R.id.stereo_video_swipe_refresh_layout)
    SwipeRefreshLayout mSwipeRefreshLayout;
    @BindView(R.id.stereo_video_progress_bar)
...
//                    + " must implement OnFragmentInteractionListener");
    ...
    private void filterCategory(List<Category> list) {
        for(Category c: list) {
            if (c.getName().equals(CATEGORY_MOVIE)) {
                mCategoryList.add(c);
            }
        }
    }
