...
public class ImageShader3D2D extends ShaderBase {
    private static final String TAG = "ImageShader3D2D";
    ...
    public ImageShader3D2D() {
        final String[] shaders = EvisUtil.get3D2DShader(EvisUtil.SHAER_TYPE_IMAGE);
        mProgram = ShaderHelper.buildProgramBinary(E3DApplication.getInstance().getApplicationContext(),
                    ShaderHelper.GLSL_IMAGE_3D2D, shaders[0], shaders[1],
